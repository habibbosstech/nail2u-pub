...
class AuthController extends Controller
{
    ...
    public function verifyEmail(Request $request, string $token, string $email)
    {
        ...
        if ($verify_email == GlobalApiResponseCodeBook::RECORD_NOT_EXISTS['outcomeCode']) {
            return $this->global_api_response->error(GlobalApiResponseCodeBook::RECORD_NOT_EXISTS, "Record not found for email verification!", $verify_email);
        }
